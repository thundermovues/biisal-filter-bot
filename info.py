...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002498006043'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002331065202'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002173900448'))
